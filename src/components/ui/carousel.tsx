  ...
  ({ className, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (
      <Button
        ...
        size={size}
        className={cn(
          "absolute z-10 h-9 w-9 rounded-full bg-card/80 text-foreground shadow-lg backdrop-blur",
          orientation === "horizontal"
            ? "-left-4 top-1/2 -translate-y-1/2 lg:-left-5"
    ...
    return (
      <Button
        ...
        className={cn(
          "absolute z-10 h-9 w-9 rounded-full bg-card/80 text-foreground shadow-lg backdrop-blur",
          orientation === "horizontal"
            ? "-right-4 top-1/2 -translate-y-1/2 lg:-right-5"
